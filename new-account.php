...
<div class="container col-sm-12  ">
    ...
    if(isset($_GET["hasil"])){
      if($_GET["hasil"] == "gagal"){
           echo "<hr><h5 class='alert alert-danger text-center'>username sudah dipakai</h5>";
      } else {
            ...
            <div class="account-wall">
               ...
               <!--  <img class="profile-img" src="https://lh5.googleusercontent.com/-b0-k99FZlyE/AAAAAAAAAAI/AAAAAAAAAAA/eu7opA4byxI/photo.jpg?sz=120"
                ...
                <form class="form-signin" action="auth.php"method="post">
                  <input type="text" class="form-control" name="nim" placeholder="NIP atau NIM" required autofocus>
                <input type="text" class="form-control" name="username" placeholder="Nama Lengkap" required autofocus>
               
               
                <input type="text" class="form-control" name="jurusan" placeholder="Jurusan" required autofocus>
