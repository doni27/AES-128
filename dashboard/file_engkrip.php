    ...
    if(isset($_GET["hasil"])){
      if($_GET["hasil"] == "gagal"){
           echo "<hr><h5 class='alert alert-danger text-center'>GAGAL EDIT! </h5>";
            ...
            echo "<hr><h5 class='alert alert-success text-center' role='alert' >berhasil menambah data</h5>";
      }
    }
  ?>
                <?php
                ...
                <h3 align="center">Judul <i ><?php echo $data2['judul'] ?></i></h3><br>
                ...
                <div class="table-responsive">
                  <table class="table striped">
                              ...
                              $sandi1 = $filename.$tgl;
                               ...
                               // $query4     = "UPDATE karya_ilmiah SET  size_dokumen1 ='$size1', sandi_dokumen1 = '$sandi1', url_dokumen1 = 'dokument/$dokumen1'  WHERE id_karyailmiah='$id_karyailmiah'";
                    ...
                    echo'<a href="download_file.php?nama_file='.$url_dokumen.'" class=" btn btn-primary glyphicon glyphicon-download-alt" data-toggle="tooltip" data-placement="top" title="Download  File" >  </a>&nbsp<a href="review.php?nama_file='.$url_dokumen.'&dokumen='.$dokumen1.'" class=" btn btn-primary glyphicon glyphicon-eye-open" data-toggle="tooltip" data-placement="top" title="Preview File" ></a>&nbsp';

                       if ($data2['status_dokumen1'] == 1) {
                                echo '<a href="file_engkrip_proses_detail.php?id_karyailmiah='.$id_karyailmiah.'&dokumen=dokumen1" class="btn btn-primary glyphicon glyphicon-lock " data-toggle="tooltip" data-placement="top" title="Amankan File dengan Engkripsi" type="submit" name="dokumen1"> Engkripsi File</a>';
                              }elseif ($data2['status_dokumen1'] == 2){
                                echo '<a href="file_dekrip_proses_detail.php?id_karyailmiah='.$id_karyailmiah.'&dokumen=dokumen1" class="btn btn-danger glyphicon glyphicon-lock "  data-toggle="tooltip" data-placement="top" title="  File Telah Terengkripsi, Dekripsi Kebentuk Aslinya  "   type="submit" name="dokumen1"> Dekripsi File&nbsp</a>';
                               
                              }elseif ($data2['status_dokumen1'] == 3){
                                echo '<a href="file_engkrip_3_2_detail.php?id_karyailmiah='.$id_karyailmiah.'&dokumen=dokumen1" class="btn btn-success glyphicon glyphicon-lock "  data-toggle="tooltip" data-placement="top" title="  File Telah Terdekripsi, Amankan File dengan Engkripsi  "   type="submit" name="dokumen1"> Engkripsi File</a>';
                    ...
                    <p>  <?php 
                              ...
                              $sandi2 = $filename.$tgl;
                               ...
                               // $query4     = "UPDATE karya_ilmiah SET  size_dokumen2 ='$size2',sandi_dokumen2= '$sandi2',url_dokumen2='dokument/$dokumen2'  WHERE id_karyailmiah='$id_karyailmiah'";
                               //  $sql3= mysqli_query($connect, $query4); 
                     ...
                     echo'<a href="download_file.php?nama_file='.$url_dokumen.'" class=" btn btn-primary glyphicon glyphicon-download-alt" data-toggle="tooltip" data-placement="top" title="Download  File" >  </a>&nbsp<a href="review.php?nama_file='.$url_dokumen.'&dokumen='.$dokumen2.'" class=" btn btn-primary glyphicon glyphicon-eye-open" data-toggle="tooltip" data-placement="top" title="Preview File" ></a>&nbsp';
...
"   type="submit" name="dokumen2"> Dekripsi File&nbsp</a>';
                   ...
                   <p> <?php 
                    ...
                    echo'<a href="download_file.php?nama_file='.$url_dokumen.'" class=" btn btn-primary glyphicon glyphicon-download-alt" data-toggle="tooltip" data-placement="top" title="Download  File" >  </a>&nbsp<a href="review.php?nama_file='.$url_dokumen.'&dokumen='.$dokumen3.'" class=" btn btn-primary glyphicon glyphicon-eye-open" data-toggle="tooltip" data-placement="top" title="Preview File" ></a>&nbsp';
                  ...
                  $status_dokumen = 'status_dokumen4';
                    ...
                    echo'<a href="download_file.php?nama_file='.$url_dokumen.'" class=" btn btn-primary glyphicon glyphicon-download-alt" data-toggle="tooltip" data-placement="top" title="Download  File" >  </a>&nbsp<a href="review.php?nama_file='.$url_dokumen.'&dokumen='.$dokumen4.'" class=" btn btn-primary glyphicon glyphicon-eye-open" data-toggle="tooltip" data-placement="top" title="Preview File" ></a>&nbsp';
...
Amankan File dengan Engkripsi" type="submit" name="dokumen1"> Engkripsi File</a>';
                    ...
                    &nbsp' ;
                     ...
                     echo'<a href="download_file.php?nama_file='.$url_dokumen.'" class=" btn btn-primary glyphicon glyphicon-download-alt" data-toggle="tooltip" data-placement="top" title="Download  File" >  </a>&nbsp<a href="review.php?nama_file='.$url_dokumen.'&dokumen='.$dokumen6.'" class=" btn btn-primary glyphicon glyphicon-eye-open" data-toggle="tooltip" data-placement="top" title="Preview File" ></a>&nbsp';
                    ...
                    &nbsp' ;
                     ...
                     echo'<a href="download_file.php?nama_file='.$url_dokumen.'" class=" btn btn-primary glyphicon glyphicon-download-alt" data-toggle="tooltip" data-placement="top" title="Download  File" >  </a>&nbsp<a href="review.php?nama_file='.$url_dokumen.'&dokumen='.$dokumen7.'" class=" btn btn-primary glyphicon glyphicon-eye-open" data-toggle="tooltip" data-placement="top" title="Preview File" ></a>&nbsp';
                    ...
                    &nbsp' ;
                     ...
                     echo'<a href="download_file.php?nama_file='.$url_dokumen.'" class=" btn btn-primary glyphicon glyphicon-download-alt" data-toggle="tooltip" data-placement="top" title="Download  File" >  </a>&nbsp<a href="review.php?nama_file='.$url_dokumen.'&dokumen='.$dokumen8.'" class=" btn btn-primary glyphicon glyphicon-eye-open" data-toggle="tooltip" data-placement="top" title="Preview File" ></a>&nbsp';
                    ...
                    echo'<a href="download_file.php?nama_file='.$url_dokumen.'" class=" btn btn-primary glyphicon glyphicon-download-alt" data-toggle="tooltip" data-placement="top" title="Download  File" >  </a>&nbsp<a href="review.php?nama_file='.$url_dokumen.'&dokumen='.$dokumen9.'" class=" btn btn-primary glyphicon glyphicon-eye-open" data-toggle="tooltip" data-placement="top" title="Preview File" ></a>&nbsp';
...
Amankan File dengan Engkripsi" type="submit" name="dokumen9"> Engkripsi File</a>';
                    ...
                    &nbsp' ;
                     ...
                     echo'<a href="download_file.php?nama_file='.$url_dokumen.'" class=" btn btn-primary glyphicon glyphicon-download-alt" data-toggle="tooltip" data-placement="top" title="Download  File" >  </a>&nbsp<a href="review.php?nama_file='.$url_dokumen.'&dokumen='.$dokumen10.'" class=" btn btn-primary glyphicon glyphicon-eye-open" data-toggle="tooltip" data-placement="top" title="Preview File" ></a>&nbsp';
                    ...
                    &nbsp' ;
                      ...
                      <p>Abstrak :</p>
                       ...
                       <tr>
                         <td>Jurusan</td>
                         <td>:</td>
                         <td><?php echo $data2['nama_sub_jurusan']; ?>
                          
                           <?php $id = $data2['idfakultas']; ?>
                            <?php   $query = mysqli_query($connect, "SELECT * FROM id_fakultas WHERE id_fakultas = $id  ");
...
<?php 
 ...
 $query4     = "UPDATE karya_ilmiah SET  fakultas ='$nama_fakultas'  WHERE id_karyailmiah='$id_karyailmiah'";
                                $sql3= mysqli_query($connect, $query4); 
 ?>
                       ...
                       <tr>
                         <td>Tipe</td>
                         <td>:</td>
                         <td><?php echo $data2['nama_tipe']; ?>
                         <?php   $p =  $data2['nama_sub_subjek'];
                          ?>
                         </td>
                         <?php 
                          $query5     = "UPDATE karya_ilmiah SET  subjek ='$p'  WHERE id_karyailmiah='$id_karyailmiah'";
                                $sql3= mysqli_query($connect, $query5); 
                                 ?>
                       </tr>
                       <tr>
                         <td>Subjek</td>
                         <td>:</td>
                         <td>
                          <?php echo $data2['nama_sub_subjek']; ?>
                         --><?php echo $data2['nama_subjek']; ?></td>
                       </tr>
                        <tr>
                         <td>Editor</td>
                         <td>:</td>
                       ...
                       <tr>
                         ...
                         <td></td>
                         <td>
                          <a href="file_form_edit.php?id_karyailmiah=<?php   echo $id_karyailmiah ?>" ><i class="fa fa-edit btn btn-danger">Edit</i></a>

                           </a> <a href="file_hapus.php?id_karyailmiah=<?php   echo $id_karyailmiah ?>" onclick="return confirm('yakin');" ><i class="glyphicon glyphicon-trash btn btn-success">Hapus</i></a>
                          
                          <a class=" btn btn-primary " data-toggle="tooltip" data-placement="top"  href="file_data.php">selesai</a>
                         </td>
                       </tr>
                  </table>
